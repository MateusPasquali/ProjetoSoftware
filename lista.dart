      ...
      body: SafeArea(
        child: GestureDetector(
          ...
          child: Column(
            ...
            children: [
              StreamBuilder<List<TextoRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  List<TextoRecord> listViewTextoRecordList = snapshot.data!;
                  return ListView.builder(
                    padding: EdgeInsets.zero,
                    shrinkWrap: true,
                    scrollDirection: Axis.vertical,
                    itemCount: listViewTextoRecordList.length,
                    itemBuilder: (context, listViewIndex) {
                      final listViewTextoRecord =
                          listViewTextoRecordList[listViewIndex];
                      return Container(
                        width: 100,
                        height: 100,
                        ...
                        child: StreamBuilder<List<TextoRecord>>(
                          ...
                          builder: (context, snapshot) {
                            ...
                            List<TextoRecord> textTextoRecordList =
                                snapshot.data!;
                            return Text(
                              textTextoRecordList.length.toString(),
